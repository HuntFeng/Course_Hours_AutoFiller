...
# Form implementation generated from reading ui file './Asset/main.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.SpanningRole, self.pushButton_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Autofiller"))
        ...
        self.lineEdit_3.setPlaceholderText(_translate("MainWindow", "birthday"))
        self.label_4.setText(_translate("MainWindow", "Address"))
        self.lineEdit_4.setPlaceholderText(_translate("MainWindow", "home address"))
        ...
        self.lineEdit_6.setPlaceholderText(_translate("MainWindow", "9-digit number"))
        self.label_7.setText(_translate("MainWindow", "Hourly Rate"))
        self.lineEdit_7.setPlaceholderText(_translate("MainWindow", "ex. 30$/h, enter 30"))
        self.label_8.setText(_translate("MainWindow", "Increment per Student"))
        self.lineEdit_8.setPlaceholderText(_translate("MainWindow", "if hourly rate is fiexed, enter 0"))
        self.label_9.setText(_translate("MainWindow", "Maximum Rate"))
        self.lineEdit_9.setPlaceholderText(_translate("MainWindow", "ex. 45$/h, enter 45"))
        self.pushButton.setText(_translate("MainWindow", "Update User Info"))
        self.pushButton_2.setText(_translate("MainWindow", "Generate Excel Sheet"))
        ...
        if(op.exists("user_info.json")):
            ...
            maximum_rate = info['payment']['maximum_rate']
            ...
            self.lineEdit_9.setText(_translate("MainWindow", str(maximum_rate)))
    ...
    def update_user_info_json(self):
        ...
        maximum_rate = float( self.lineEdit_9.text() )
        ...
        data = {
            ...
            "SIN": SIN,
            "payment":{ "hourly_rate": hourly_rate,\
                        "increment_per_student": increment_per_student,\
